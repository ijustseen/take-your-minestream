...
|-----------|--------------|------|
| **1.21** | `tyms-1.4.2+1.21.jar` | 21 |
| **1.21.1** | `tyms-1.4.2+1.21.1.jar` | 21 |
| **1.21.4** | `tyms-1.4.2+1.21.4.jar` | 21 |
| **1.21.8** | `tyms-1.4.2+1.21.8.jar` | 21 |
| **1.21.10** | `tyms-1.4.2+1.21.10.jar` | 21 |
| **1.21.11** | `tyms-1.4.2+1.21.11.jar` | 21 |
| **26.1** / **26.1.1** / **26.1.2** | `tyms-1.4.2+26.1.jar` | 25 |
